...
export default function CompareScreen() {
  ...
  // Calculate simple stats for comparison
  const getStats = (s: typeof loanScenarios.$inferSelect) => {
    const r = (s.fixedAnnualRate || 0) / 12;
    ...
    return { payment, total, interest: total - s.principal };
  };
            ...
            return (
              ...
              >
                <View>
                  ...
                  <Text style={[styles.itemSub, isSelected && styles.textSelected]}>${s.principal} • {s.termMonths}mo</Text>
                </View>
