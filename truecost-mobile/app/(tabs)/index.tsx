  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.outlookCard}>
        <View style={styles.cardHeader}>
          <View>
            ...
            <Text style={styles.outlookValue}>Neutral</Text>
          </View>
        ...
        <Text style={styles.outlookDesc}>
          Central banks are expected to hold rates. Consider locking fixed rates for stability.
        </Text>
      </View>
      ...
      <View style={styles.sectionMargin}>
        <AiTipsCard 
          tips={[`Total debt exposure is ${formatMoney(kpiStats.totalPrincipal)}. Consider consolidating higher rate loans.`]} 
        />
      </View>
